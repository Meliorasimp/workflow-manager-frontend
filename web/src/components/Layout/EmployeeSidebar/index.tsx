...
import { setIsMyTaskDropdownOpen } from "../../../store/features/employeedashboard";
import { AnimatePresence, motion } from "framer-motion";
const EmployeeSidebar = () => {
  const dispatch = useDispatch();
  const { isMyTaskDropdownOpen } = useSelector(
  ...
  return (
    <div className="text-white flex flex-col gap-y-2 h-screen w-1/7 border-r border-gray-800 pt-5 px-3">
      ...
      <div
        className="text-md font-semibold flex items-center gap-x-2 hover:bg-gray-600 p-2 rounded-md cursor-pointer"
        onClick={() => dispatch(setIsMyTaskDropdownOpen(!isMyTaskDropdownOpen))}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
        ...
        <h1 className="text-md font-semibold bg-linear-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent mr-auto">
          My Tasks
        </h1>
        {isMyTaskDropdownOpen ? (
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <AnimatePresence>
        {isMyTaskDropdownOpen && (
          ...
          >
            <div className="ml-4 mt-1 hover:bg-gray-600 p-2 rounded-lg cursor-pointer flex items-center gap-x-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
